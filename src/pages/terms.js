...
const TermsPage = () => (
  <Layout>
    <SEO title="Machol &amp; Johannes LLC Attorneys At Law - Privacy Policy" />
        ...
        <p className="font-medium">2. Description of Services</p>

        <p>We make various services available on this site including, but not limited to, Collection, Bankruptcy, Creditor Rights, and other like services. You are responsible for providing, at your own expense, all equipment necessary to use the services, including a computer, modem, and Internet access (including payment of all fees associated with such access).</p>
        ...
        <p className="font-medium">3. Conduct on Site</p>
        ...
        <p>a. is unlawful, threatening, abusive, harassing, defamatory, libelous, deceptive, fraudulent, invasive of another&rsquo;s privacy, tortious, contains explicit or graphic descriptions or accounts of sexual acts (including but not limited to sexual language of a violent or threatening nature directed at another individual or group of individuals), or otherwise violates our rules or policies;</p>
        ...
        <p className="font-medium">4. Third Party Sites and Information</p>
        ...
        <p className="font-medium">5. Intellectual Property Information</p>

        <p>Copyright (c) January 1, 2010 Machol &amp; Johannes All Rights Reserved.</p>
        ...
        <p>All custom graphics, icons, logos and service names are registered trademarks, trademarks or service marks of Machol &amp; Johannes or its Affiliates. All other trademarks or service marks are property of their respective owners. Nothing in these Terms of Use grants you any right to use any trademark, service mark, logo, and/or the name of Machol &amp; Johannes or its Affiliates.</p>

        <p className="font-medium">6. Unauthorized Use of Materials</p>
        ...
        <p>Click the Contact button at the top of the website. Or send conventional mail.</p>

        <p>You acknowledge and agree that upon receipt of a notice of a claim of copyright infringement, we may immediately remove the identified materials from our site without liability to you or any other party and that the claims of the complaining party and the party that originally posted the materials will be referred to the United States Copyright Office for adjudication as provided in the Digital Millennium Copyright Act.</p>

        <p className="font-medium">7. Disclaimer of Warranties</p>
        ...
        <p className="font-medium">9. Indemnification</p>
        ...
        <p className="font-medium">10. Security and Password</p>
        ...
        <p className="font-medium">11. Participation in Promotions</p>
        ...
        <p className="font-medium">12. E-mail, Messaging, Blogging, and Chat Services</p>
        ...
        <p className="font-medium">13. International Use</p>
        ...
        <p className="font-medium">14. Termination of Use</p>
        ...
        <p className="font-medium">15. Governing Law</p>

        <p>This site (excluding any linked sites) is controlled by us from our offices within the Colorado and Washington, United States of America. It can be accessed from all 50 states, as well as from other countries around the world. As each of these places has laws that may differ from those of Colorado and Washington, by accessing this site both of us agree that the statutes and laws of the State of Colorado and Washington, without regard to the conflicts of laws principles thereof and the United Nations Convention on the International Sales of Goods, will apply to all matters relating to the use of this site and the purchase of products and services available through this site. Each of us agrees and hereby submits to the exclusive personal jurisdiction and venue any court of competent jurisdiction within the State of Colorado and Washington with respect to such matters.</p>

        <p className="font-medium">16. Notices</p>

        <p>All notices to a party shall be in writing and shall be made either via email or conventional mail. Notices to us must be sent to the attention of Customer Service by clicking the Contact button at the top of the website, if by email, or at Machol &amp; Johannes 700 17th Street, Suite 200,&nbsp; Denver, CO&nbsp; 80202 if by conventional mail. We may broadcast notices or messages through the site to inform you of changes to the site or other matters of importance, and such broadcasts shall constitute notice to you at the time of sending.</p>

        <p className="font-medium">17. Entire Agreement</p>
        ...
        <p className="font-medium">18. Miscellaneous</p>

        <p>In any action to enforce these Terms of Use, the prevailing party will be entitled to costs and attorneys&rsquo; fees. Any cause of action brought by you against us or our Affiliates must be instituted with one year after the cause of action arises or be deemed forever waived and barred.</p>
        ...
        <p className="font-medium">19. Contact Information</p>

        <p>Except as explicitly noted on this site, the services available through this site are offered by Machol &amp; Johannes located at 700 17th Street, Suite 200,&nbsp; Denver, CO&nbsp; 80202. Our telephone number is 303-830-0075. If you notice that any user is violating these Terms of Use <Link to="/Contact" className="text-blue01 underline  font-medium">please click here to contact us</Link>.</p>

        <p><span className="font-medium">CLICK HERE FOR INFORMATION ABOUT THE COLORADO</span> <Link to="https://urldefense.proofpoint.com/v2/url?u=HTTPS-3A__COAG.GOV_OFFICE-2DSECTIONS_CONSUMER-2DPROTECTION_CONSUMER-2DCREDIT-2DUNIT_COLLECTION-2DAGENCY-2DREGULATION_&d=DwMGaQ&c=euGZstcaTDllvimEN8b7jXrwqOf-v5A_CdpgnVfiiMM&r=y47BxePAs_nXrhp7DKQnQ4r-fIXxQ1tV9n5j7M610qLXNP_-ZOKKX1s5SrBRs84t&m=soWPyCBX-sJKTywUQQSqZlr0y4woSpGa2kL16yB6rWs&s=vQ4qTCUjlMXGcCKSxiaUe-3w76IRVjlJU697anvSuzY&e=" className="text-blue01 underline  font-medium">FAIR DEBT COLLECTION PRACTICES ACT</Link></p>
    </div>
